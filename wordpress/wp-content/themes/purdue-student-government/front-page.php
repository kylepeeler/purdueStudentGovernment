			...
			<div class="row icon-row">
					...
					<div class="ih-item circle colored effect3 bottom_to_top">
						...
						<div class="info">
							<ul>
								...
								<li><a href="#">Administration Initiatives</a></li>
								<li><a href="#">External Student Representation</a></li>
							</ul>
						</div>
					</div>
					<!-- end colored -->
				...
				<div class="col-lg-4">
					...
					<div class="ih-item circle colored effect3 bottom_to_top">
						...
						<div class="info">
							<ul>
								<li><a href="#">Student Senate</a></li>
								<li><a href="#">Committees</a></li>
								<li><a href="#">Upcoming Meetings</a></li>
								<li><a href="#">Minutes and Voting Records</a></li>
								<li><a href="#">Enacted Legislation</a></li>
							</ul>
						</div>
					</div>
					<!-- end colored -->
					...
					<div class="ih-item circle colored effect3 bottom_to_top">
						...
						<div class="info">
							<ul>
								...
								<li><a href="#">File a Case or Motion</a></li>
								<li><a href="#">Purdue Student Supreme Court</a></li>
								<li><a href="#">University Rules and Regulations</a></li>
							</ul>
						</div>
					</div>
					<!-- end colored -->
					...
					<div class="ih-item circle colored effect3 bottom_to_top">
						...
						<div class="info">
							<ul>
								...
								<li><a href="#">PSG Scholarships</a></li>
								<li><a href="#">Funding FAQ</a></li>
							</ul>
						</div>
					</div>
					<!-- end colored -->
				...
				<div class="col-lg-3">
					...
					<div class="ih-item circle colored effect3 bottom_to_top">
						...
						<div class="info info-small">
							<ul>
								<li><a href="#">Campus Safety Task Force</a></li>
								<li><a href="#">Presidents’ Roundtable</a></li>
								<li><a href="#">PSG Applications and Elections</a></li>
								<li><a href="#">PUSH</a></li>
								<li><a href="#">CAPS</a></li>
								<li><a href="#">Student Legal Services</a></li>
								<li><a href="#">Purdue University Financial Aid</a></li>
								<li><a href="#">Boilerlink</a></li>
							</ul>
						</div>
					</div>
					<!-- end colored -->
